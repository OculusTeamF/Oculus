 ...
 */
public class ExaminationDaoAdapter implements IExaminationDaoTb2, ILogger {
    @Override
    public void saveOrUpdate(IExaminationTb2 iExaminationTb2) throws PersistenceExceptionTb2 {
        Facade facade = Facade.getInstance();
        try {
            facade.save((IExaminationResult)iExaminationTb2);
