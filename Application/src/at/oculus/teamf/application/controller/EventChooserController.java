 ...
 * @since $28.05.2015
 * <p>
 * <b>Description:</b> This File contains the EventChooserController class, which is after the login of a patient on the
 * webapplication, responsible for the management of choosing an event.
 */
public class EventChooserController implements ILogger {
	 ...
	 * <p>
	 * <b>Description:</b> this is the constructor of the EventChooserController. To get an instance of this controller,
	 * an interface of a patient has to be set at the beginning (because the patient has to be logged in)
	 * <p>
	 * <b>Parameter</b>
	 *
	 * @param patient
	 * 		this parameter shows the interface of the patient, who wants to choose an event
	 */
	...
	public static EventChooserController createEventChooserController(IPatient iPatient)
			throws PatientCanNotBeNullException {
		if (iPatient == null) {
	 ...
	 * <p>
	 * <b>Description:</b> This method deletes the existing event from a patient. If the event can not be deleted (for
	 * whatever reason), an exception is thrown or the method returns the value false. If the Event is deleted
	 * successfully, the method returns the value true.
	 * <p>
	 * *<b>Parameter</b>
	 *
	 * @param event
	 * 		this is the calendar-event, which should be deleted
	 */
	public Collection<ICalendarEvent> deleteExistingEvent(ICalendarEvent event)
			throws EventCanNotBeNullException, EventCanNotBeDeletedException {
		if (event == null) {
	 ...
	 * <h3>$checkDate</h3>
	 * <p>
	 * <b>Description:</b> This method checks if the given date is at least 2 days in the future. If not, the method
	 * returns the value false
	 * <p>
	 * *<b>Parameter</b>
	 *
	 * @param date
	 * 		this is the date, which should be checked
	 */
	 ...
	 * <p>
	 * <b>Description:</b> this method gets all available information from the variables of this class, with which some
	 * suitable calendar-events are searched. First it checks if the patient is allowed to choose a new appointment, by
	 * checking his or her future appointments again. It returns a collection of calendar-events, or an empty
	 * collection, if there are no fitting events available. Make sure you used the methods addDatePeriodCriteria and
	 * addWeekDayTimeCriteria first!
	 */
	public Collection<ICalendarEvent> getAvailableEvents()
			throws NotAllowedToChooseEventException, NoDoctorException, ReloadInterfaceNotImplementedException,
			       InvalidReloadClassException, BadConnectionException, NoBrokerMappedException,
		...
		if (weekDayTimeCollection.size() > 0) {
		...
		if (datePeriodCollection.size() > 0) {
			for (int i = 0; i < datePeriodCollection.size(); i++) {
				IDatePeriodCriteria datePeriodICriteria =
						((LinkedList<IDatePeriodCriteria>) datePeriodCollection).get(i);
		...
		try {
			iterator =
					at.oculus.teamf.domain.entity.calendar.Calendar.availableEventsIterator(iCalendar, criterias, 30);
	 ...
	 * <p>
	 * <b>Description:</b> this method creates new week day time criterias. It creates a new WeekDayTime when the
	 * patient wants to come and adds it to a collection which is also returned.
	 * <p>
	 * <b>Parameter</b>
	 *
	 * @param start
	 * 		this is the starttime of the period in which the patient wants to come
	 * @param end
	 * 		this is the endtime of the period in which the patient wants to come
	 * @param weekDay
	 * 		this is the weekday on which the patient wants to come. Make sure it has the correct format: SUN, MON, TUE,
	 * 		WED, THU, FRI or SAT
	 */
	 ...
	 * <p>
	 * <b>Description:</b> this method creates new date period criterias. It creates a new date period when the patient
	 * is not able to come and saves it.
	 * <p>
	 * <b>Parameter</b>
	 *
	 * @param start
	 * 		this is the starttime of the period in which the patient can not come
	 * @param end
	 * 		this is the endtime of the period in which the patient can not come
	 */
	 ...
	 * <p>
	 * <b>Description:</b> this method saves the given calendar-event to the specified patient into the database and
	 * returns the value true, if everything works.
	 * <p>
	 * <b>Parameter</b>
	 *
	 * @param iCalendarEvent
	 * 		this is the chosen calendar-event, which should be fixed
	 */
	 ...
	 * <p>
	 * <b>Description:</b> this method checks if the specified patient already has future appointments. The method
	 * returns a collection of ICalendarEvents. The collectioin is empty, if there is no future appointment saved for
	 * the patient. If the size of the collection is bigger than 0, the patient already has future appointments, and is
	 * not allowed to choose another one.
	 */
	 ...
	 * <h3>$getEventTypes</h3>
	 * <p>
	 * <b>Description:</b> this method returns the available Eventtypes. (Standardterimn, Kindertermin...)
	 */
