...
public class RemovePatientControllerTest {

    @org.junit.Test
    public void testRemovePatientFromDatabase() throws Exception {
        ...
        for (IPatient patient : patients){
            removePatientController.removePatientFromDatabase(patient);
        }

        assert (searchPatientController.searchPatients("Gruber").size() == 0);
    }
}